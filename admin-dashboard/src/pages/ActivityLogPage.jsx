...
export default function ActivityLogPage() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      link.setAttribute(
        "download",
        `activity_report_${new Date().toISOString().split("T")[0]}.csv`,
      );
      ...
      >
        {logs.map((log) => (
          ...
          >
            ...
            <td className="px-4 py-3">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <span className="text-[10px] text-text-secondary font-bold opacity-50 uppercase tracking-wider">
                    Admin
                  </span>
                </div>
              </div>
            ...
            <td className="px-4 py-3">
              <span
                className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border ${getActionStyles(log.action)}`}
              >
