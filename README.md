...
**AI Vision Assistant** là một giải pháp công nghệ toàn diện nhằm hỗ trợ người dùng nhận biết môi trường xung quanh, đọc văn bản, nhận diện mệnh giá tiền, cảnh báo nguy hiểm bằng âm thanh bằng AI theo thời gian thực. Hệ thống được thiết kế với độ trễ thấp, kết hợp giữa Edge AI (trên thiết bị) và Cloud AI (xử lý sâu).
...
### 🧠 2. Cách Train Model mới (Fine-tuning)
