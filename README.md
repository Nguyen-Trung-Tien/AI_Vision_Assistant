...
| Ngày      | Cập nhật                          | Mô tả                                                                                                                                                                          |
| --------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **24/05** | 🗣️ Tối ưu chống lặp TTS           | Gỡ bỏ bộ lọc chống lặp chữ (Anti-spam TTS) cho các chế độ chụp thủ công (Đọc sách, Phân tích bố cục, v.v.), đảm bảo luôn đọc kết quả khi người dùng yêu cầu quét lại trang cũ. |
| **24/05** | 👁️ Tối ưu hiển thị văn bản        | Khung hiển thị chữ khi đang đọc (Online/Offline) giờ đây luôn giữ 100% độ sáng rành mạch và được chuyển lên lớp trên cùng để không bị làm mờ bởi hình nền.                     |
| **24/05** | ✋ Thao tác ngắt giọng thông minh | Cho phép nhấp đúp (Double Tap) ở bất kỳ đâu trên màn hình lúc máy đang đọc (Đọc Online/Offline, Bố cục) để ngắt âm thanh và thoát về màn hình camera ngay lập tức.             |

### 🗓️ Tháng 5/2026 — v2.1.1
...
8. **📱 TFLite Offline Money Fix (Mới)**:
...
10. **🔗 Detection Payload End-to-End**:
...
11. **💯 Confidence Display Improvement**:
